...
import com.theappwelt.vhelp.api.SaveProfileInfoAPI;
...
public class ProfileMenuActivity extends AppCompatActivity {
    ...
    @BindView(R.id.editTextName) EditText editTextIDUser;
    @BindView(R.id.editTextMobile) EditText editTextNamaUser;
    @BindView(R.id.editTextNoHP) EditText editTextNoHP;
    @BindView(R.id.layoutName) TextInputLayout validasiIDUser;
    @BindView(R.id.layoutMobile) TextInputLayout validasiNamaUser;
